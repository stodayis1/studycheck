    ...
    items: [
      {
        ...
        steps: [
          '「오늘 할 일」에서 수업일지 미입력 · 채점 대기 · 학부모 공유 대기 · 채점 후 처리 필요 · 상담 필요(90일 초과)를 확인해요.',
          '다른 선생님이 남긴 「학생 전달사항」을 읽고 「확인」을 눌러요.',
          '첫수업 알림장을 아직 안 쓴 학생(⚠ 표시)을 챙겨요.',
    ...
    items: [
      {
        ...
        steps: [
          '오늘 수업 학생 옆 「✏️ 입력」 → 진도 개념 체크, 출결, 과제 달성률, 과제(교재·학습지·영상·시험대비)를 넣고 「수업일지 저장」.',
    ...
    items: [
      {
        ...
        steps: [
          ...
          '잘못 눌렀으면 「최근 24시간 완료 처리」에서 「↩️ 되돌리기」.',
